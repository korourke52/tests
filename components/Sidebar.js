// Sidebar.js - Navigation sidebar for Nova app
...
function Sidebar({ activeTab = 'chat', onTabChange, userName = 'Sarah' }) {
  ...
  return (
    ...
    >
      {/* Top Section */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: `${theme.spacing[6]}px` }}>
        {/* Logo */}
        <div
          style={{
        ...
        {/* Navigation Items */}
        <nav style={{ display: 'flex', flexDirection: 'column', gap: `${theme.spacing[2]}px` }}>
          {navItems.map((item) => (
            <NavItem
              key={item.id}
              icon={item.icon}
      ...
      {/* Bottom Section */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: `${theme.spacing[4]}px` }}>
        {/* Get Help Button */}
        <button
          style={{
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: `${theme.spacing[2]}px` }}>
            {/* Avatar */}
            <div
              style={{
                width: '28px',
